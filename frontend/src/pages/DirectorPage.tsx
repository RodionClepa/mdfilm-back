...
import type { Director, Media } from '../types';
import '../App.css';
    ...
    <div className="app profile-page">
      <div className="profile-hero">
        <div className="profile-hero-top">
          <div>
            <div className="profile-kicker">{t(lang, 'role_director')}</div>
            <div className="profile-title">{item?.name ?? t(lang, 'role_director')}</div>
          </div>
        </div>
      </div>
